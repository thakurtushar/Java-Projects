...
public class TStu implements ActionListener{
	...
	public TStu() {
		...
		textField.setBounds(379, 74, 238, 22);
		f.getContentPane().add(textField);
		textField.setColumns(10);
		
		dm=new DefaultTableModel(new String[] {"REG DATE","REG ID","NAME","BRANCH","YEAR","SEMESTER","DATE OF BIRTH","FACILITY","GENDER","FATHER'S NAME","MOTHER'S NAME"},0);
		table = new JTable();
		JScrollPane js=new JScrollPane(table);
		js.setBounds(24, 129, 652, 158);
		f.getContentPane().add(js);
		
		btnBack = new JButton("BACK");
		btnBack.setFont(new Font("Times New Roman", Font.BOLD, 15));
		btnBack.setBounds(611, 312, 89, 23);
